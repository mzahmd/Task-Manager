...
export default function Tasks() {
  ...
  return (
    <div className="my-5">
      ...
      <button className="font-bold bg-emerald-500 hover:bg-emerald-700 rounded text-slate-200 shadow ms-2 py-1 px-2" type="button" onClick={handleAddTask}>ADD</button>
